  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="boutiqueApp.customerDetails.home.createOrEditLabel" data-cy="CustomerDetailsCreateUpdateHeading">
            <Translate contentKey="boutiqueApp.customerDetails.home.createOrEditLabel">Create or edit a CustomerDetails</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('boutiqueApp.customerDetails.gender')}
              ...
              >
                {genderValues.map(gender => (
                  <option value={gender} key={gender}>
                    {translate('boutiqueApp.Gender.' + gender)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('boutiqueApp.customerDetails.phone')}
              ...
              />
              <ValidatedField
                label={translate('boutiqueApp.customerDetails.addressLine1')}
              ...
              />
              <ValidatedField
                label={translate('boutiqueApp.customerDetails.addressLine2')}
              ...
              />
              <ValidatedField
                label={translate('boutiqueApp.customerDetails.city')}
              ...
              />
              <ValidatedField
                label={translate('boutiqueApp.customerDetails.country')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('boutiqueApp.customerDetails.user')}
                type="select"
                required
              >
                <option value="" key="0" />
